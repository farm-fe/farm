    ...
    switch (arch) {
      ...
      case "ia32":
        if (existsSync(join(currentDir, "../npm/win32-ia32-msvc/index.farm"))) {
          ...
          binPath = require.resolve(
            "<FARM-RUST-PLUGIN-NPM-NAME>-win32-ia32-msvc"
          );
        }
      ...
      case "arm64":
        if (
          ...
          binPath = require.resolve(
            "<FARM-RUST-PLUGIN-NPM-NAME>-win32-arm64-msvc"
          );
        }
      ...
      case "x64":
        if (isMusl()) {
          if (
            ...
            binPath = require.resolve(
              "<FARM-RUST-PLUGIN-NPM-NAME>-linux-x64-musl"
            );
          }
        } else {
      ...
      case "arm64":
        if (isMusl()) {
          if (
            ...
            binPath = require.resolve(
              "<FARM-RUST-PLUGIN-NPM-NAME>-linux-arm64-musl"
            );
          }
        } else {
          if (
            ...
            binPath = require.resolve(
              "<FARM-RUST-PLUGIN-NPM-NAME>-linux-arm64-gnu"
            );
          }
        }
        break;
