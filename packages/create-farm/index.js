...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'x64') {
      try {
        return require('./create-farm.win32-x64-msvc.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        return require('create-farm-win32-x64-msvc')
      } catch (e) {
        loadErrors.push(e)
      }
    } else if (process.arch === 'ia32') {
      try {
        return require('./create-farm.win32-ia32-msvc.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        return require('create-farm-win32-ia32-msvc')
      } catch (e) {
        loadErrors.push(e)
      }
    } else if (process.arch === 'arm64') {
      try {
        return require('./create-farm.win32-arm64-msvc.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        return require('create-farm-win32-arm64-msvc')
      } catch (e) {
        loadErrors.push(e)
      }
    } else {
    ...
    try {
      return require('./create-farm.darwin-universal.node')
    } catch (e) {
      loadErrors.push(e)
    }
    try {
      return require('create-farm-darwin-universal')
    } catch (e) {
      loadErrors.push(e)
    }
    if (process.arch === 'x64') {
      try {
        return require('./create-farm.darwin-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        return require('create-farm-darwin-x64')
      } catch (e) {
        loadErrors.push(e)
      }
    } else if (process.arch === 'arm64') {
      try {
        return require('./create-farm.darwin-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        return require('create-farm-darwin-arm64')
      } catch (e) {
        loadErrors.push(e)
      }
    } else {
    ...
    if (process.arch === 'x64') {
      if (isMusl()) {
        try {
          return require('./create-farm.linux-x64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          return require('create-farm-linux-x64-musl')
        } catch (e) {
          loadErrors.push(e)
        }
      } else {
        try {
          return require('./create-farm.linux-x64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          return require('create-farm-linux-x64-gnu')
        } catch (e) {
          loadErrors.push(e)
        }
      }
      ...
      if (isMusl()) {
        try {
          return require('./create-farm.linux-arm64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          return require('create-farm-linux-arm64-musl')
        } catch (e) {
          loadErrors.push(e)
        }
      } else {
        try {
          return require('./create-farm.linux-arm64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          return require('create-farm-linux-arm64-gnu')
        } catch (e) {
          loadErrors.push(e)
        }
      }
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  try {
    nativeBinding = require('./create-farm.wasi.cjs')
  } catch (err) {
  ...
  if (!nativeBinding) {
    try {
      nativeBinding = require('create-farm-wasm32-wasi')
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
        loadErrors.push(err)
      }
