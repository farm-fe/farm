...
// These placeholder will be replaced during compilation
globalThis.__farm_module_system_resources__ = JSON.parse(
  __FARM_MODULE_SYSTEM_RESOURCES__
);
globalThis.__farm_module_system_public_paths__ = JSON.parse(
  __FARM_MODULE_SYSTEM_PUBLIC_PATHS
);

globalThis.__acquire_farm_module_system__ = (function (resources, publicPaths) {
  class ModuleSystem {
