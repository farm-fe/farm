use farmfe_core::swc_ecma_ast::{ModuleItem, Ident, self, ModuleExportName};
use farmfe_toolkit::swc_ecma_visit::VisitWith;

use super::{StatementId, ImportInfo, ExportInfo, ImportSpecifierInfo, ExportSpecifierInfo, used_idents_collector::{self, UsedIdentsCollector}};

pub fn analyze_imports_and_exports(id: &StatementId, stmt: &ModuleItem) -> (Option<ImportInfo>, Option<ExportInfo>, Vec<Ident>, Vec<Ident>) {
