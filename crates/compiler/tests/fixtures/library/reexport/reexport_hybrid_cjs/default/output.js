...
var foo_ts_default = interopRequireDefault(__farm_cjs_exports__$1).default;
...
const bar = 'foo';
; // module_id: index.ts
var index_ts_default = foo_ts_default;
export { bar as bar, index_ts_default as default, foo as foo };
