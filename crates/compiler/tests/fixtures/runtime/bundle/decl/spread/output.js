...
var conflict_ts_cjs = __commonJs({
    "conflict.ts.farm-runtime": (module, exports)=>{
        "use strict";
        const Row = ()=>{};
        const Col = ()=>{};
        console.log({
...
console.log(Row$2, Col$1)(globalThis || window || global)["__farm_default_namespace__"].__farm_module_system__.setPlugins([]);
