//index.js:
 (globalThis || window || global)['__farm_default_namespace__'] = {__FARM_TARGET_ENV__: 'browser'};function __commonJs(mod) {
  var module;
  return () => {
    if (module) {
...
}((function(){var runtime_ts_cjs = __commonJs({
    "runtime.ts.farm-runtime": (module, exports)=>{
        "use strict";
