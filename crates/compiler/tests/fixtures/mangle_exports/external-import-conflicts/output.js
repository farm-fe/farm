...
(function(moduleSystem, modules) {
    ...
    "774fba3e": function(module, exports, farmRequire, farmDynamicRequire) {
        ...
        farmRequire._(exports, "b", _f_unresolved, "unresolved");
        var _f_unresolved1 = farmRequire('/external/deep/unresolved');
        farmRequire._(exports, "a", _f_unresolved1, "unresolvedDeep");
    },
    "b5d64806": function(module, exports, farmRequire, farmDynamicRequire) {
        ...
        console.log('index readFileSync', _f_bar.c('index'));
        console.log(_f_zoo.b, _f_zoo1.a, _f_unresolved.unresolvedDeep);
        console.log(ns);
    ...
    "c5bba42f": function(module, exports, farmRequire, farmDynamicRequire) {
        ...
        farmRequire._(exports, "c", _f_node_fs1, "existsSync");
        var _f_zoo = farmRequire("774fba3e");
        farmRequire._(exports, "b", _f_zoo, "a");
        farmRequire._(exports, "createRequire", _f_zoo);
        farmRequire._(exports, "a", _f_zoo, "b");
        var _f_zoo1 = farmRequire("774fba3e");
