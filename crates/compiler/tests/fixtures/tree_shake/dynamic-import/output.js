...
__farm_global_this__.__farm_module_system__.setInitialLoadedResources([]);__farm_global_this__.__farm_module_system__.setDynamicModuleResourcesMap({ '05ee5ec7': [{ path: 'e79a22cc.js', type: 'script' },], });(function(modules) {
