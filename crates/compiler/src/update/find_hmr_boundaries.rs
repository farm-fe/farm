...
mod tests {
  ...
  fn find_hmr_boundaries_1() {
    ...
    *module_a.meta = ModuleMetaData::Script(Box::new(ScriptModuleMetaData {
  ...
  fn find_hmr_boundaries_2() {
    ...
    *module_d.meta = ModuleMetaData::Script(Box::new(ScriptModuleMetaData {
      hmr_self_accepted: true,
      ..Default::default()
    }));
    let module_c = module_graph.module_mut(&"C".into()).unwrap();
    module_c.module_type = ModuleType::Js;
    *module_c.meta = ModuleMetaData::Script(Box::new(ScriptModuleMetaData {
      hmr_self_accepted: true,
      ..Default::default()
    }));
  ...
  fn find_hmr_boundaries_deps_2() {
    ...
    *module_f.meta = ModuleMetaData::Script(Box::new(ScriptModuleMetaData {
      hmr_self_accepted: false,
      ..Default::default()
    }));
  ...
  fn find_hmr_boundaries_deps_3() {
    ...
    *module_b.meta = ModuleMetaData::Script(Box::new(ScriptModuleMetaData {
      hmr_self_accepted: false,
    ...
    *module_e.meta = ModuleMetaData::Script(Box::new(ScriptModuleMetaData {
      hmr_self_accepted: false,
      ..Default::default()
    }));
    ...
    *module_g.meta = ModuleMetaData::Script(Box::new(ScriptModuleMetaData {
      hmr_self_accepted: false,
      ..Default::default()
    }));
