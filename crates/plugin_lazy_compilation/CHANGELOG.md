...
## [2.0.2](https://github.com/farm-fe/farm/compare/farmfe_plugin_lazy_compilation-v2.0.1...farmfe_plugin_lazy_compilation-v2.0.2) - 2026-05-30

### Other

- updated the following local packages: farmfe_utils, farmfe_core, farmfe_testing_helpers, farmfe_toolkit
