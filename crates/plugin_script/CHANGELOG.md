...
## [2.0.2](https://github.com/farm-fe/farm/compare/farmfe_plugin_script-v2.0.1...farmfe_plugin_script-v2.0.2) - 2025-10-17

### Other

- updated the following local packages: farmfe_core, farmfe_testing_helpers, farmfe_toolkit, farmfe_plugin_script_meta, farmfe_swc_transformer_import_glob
