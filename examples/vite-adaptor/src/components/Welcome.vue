    ...
    <div class="farm-desc">
      ...
      <FarmCard>
        <div class="action-box">
          ...
          <div class="action">
            <ButtonAction to="https://farm-fe.github.io/docs/quick-start">Quick Start</ButtonAction>
            <ButtonAction to="https://farm-fe.github.io/docs/why-farm">Why Farm ?</ButtonAction>
          </div>
        </div>
      </FarmCard>
    </div>
