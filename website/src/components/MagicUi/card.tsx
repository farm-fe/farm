...
const SkeletonOne = () => {
  ...
  return (
    ...
    >
      <motion.div className='flex justify-center flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 bg-soft dark:bg-soft'>
        <motion.img src={Rocket} alt='' className='w-20' variants={variants} />
      </motion.div>
    </motion.div>
  );
};
const SkeletonTwo = () => {
  ...
  return (
    ...
    >
      <motion.div className='flex justify-center flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 bg-soft dark:bg-soft'>
        <motion.img src={Box} alt='' className='w-20' variants={variants} />
      </motion.div>
    </motion.div>
  );
};
...
const items = [
  {
    ...
    description: (
      <span className='text-sm'>
        <Translate>
          Written in Rust, start a React / Vue project in milliseconds and
          perform an HMR update within 10ms for most situations.
        </Translate>
      </span>
    ),
    header: <SkeletonOne />,
    ...
    description: (
      <span className='text-sm'>
        <Translate>
          ...
          Static Assets out of the box, supports Sass, Less, PostCSS, Vue,
          React, Solid by way of official plugins, supports lazy compiling,
          partial bundling and more. Everything inside Farm is powered by
          plugins, Supports both Rust and JavaScript plugins. Support Vite
          plugins out of box.
        </Translate>
      </span>
    ),
