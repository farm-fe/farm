      ...
      <div className='px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl'>
        <div className='flex flex-col items-center sm:items-start gap-8 sm:flex-row sm:justify-between'>
          <div className='flex flex-col items-center sm:items-start gap-4'>
            <img
              className='h-12 w-36 sm:h-14 sm:w-40'
              src='https://www.farmfe.org/img/logo-farm.png'
              alt=''
            />
          ...
          <div className='w-full sm:w-auto'>
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-x-12'>
              <div>
                <p className='text-base text-gray-500 font-semibold mb-4'>
                  Guide
                </p>
                <ul className='list-none space-y-3 p-0'>
                  <li>
                    <a
                      ...
                      title=''
                      className='text-sm sm:text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80'
                    >
                      {' '}
                      Quick Start{' '}
                    </a>
