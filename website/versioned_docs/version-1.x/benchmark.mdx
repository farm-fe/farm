...
>
> Test Machineï¼ˆLinux Mint 21.1 Cinnamonï¼?11th Gen IntelÂ© Coreâ„?i5-11400 @ 2.60GHz Ã— 6ï¼?15.5 GiBï¼?


#### Install dependencies

<PackageManagerTabs command="pnpm install" />

#### run benchmark

<PackageManagerTabs command="pnpm benchmark" />
