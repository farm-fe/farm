      ...
      items: [
        "plugins/official-plugins/overview",
        {
          ...
          items: [
            ...
            "plugins/official-plugins/tailwindcss",
            "plugins/official-plugins/svgr",
            "plugins/official-plugins/wasm",
            "plugins/official-plugins/worker",
            "plugins/official-plugins/url",
            "plugins/official-plugins/dts",
            "plugins/official-plugins/icons",
            "plugins/official-plugins/image",
            "plugins/official-plugins/mdx",
            "plugins/official-plugins/compress",
            "plugins/official-plugins/modular-import",
            "plugins/official-plugins/replace-dirname",
        ...
        },
        {
          ...
          items: [
            ...
            "plugins/official-plugins/js-babel",
            "plugins/official-plugins/js-copy",
            ...
            "plugins/official-plugins/js-tailwindcss",
            "plugins/official-plugins/js-visualizer",
            "plugins/official-plugins/js-electron",
            "plugins/official-plugins/js-qiankun",
            "plugins/official-plugins/js-react-compiler",
            "plugins/official-plugins/js-vuetify",
          ],
        },
      ],
    },
