...
`Farm` 提供完整的开发服务器、编译器、监听器等 `JavaScript Api`, 开发者可以通过引入 `farm` 包来使用这些 Api。
...
<>
    <Tabs>
          <TabItem value="npm" label="npm">
              <CodeBlock>npm install farm@latest</CodeBlock>
              </TabItem>

  <TabItem value="yarn" label="yarn">
          <CodeBlock>yarn add farm@latest</CodeBlock>
              </TabItem>
  <TabItem value="pnpm" label="pnpm">
          <CodeBlock>pnpm add farm@latest</CodeBlock>
              </TabItem>
          </Tabs>
</>
